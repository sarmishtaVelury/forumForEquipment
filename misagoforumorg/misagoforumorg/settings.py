"""
Django settings for misagoforumorg project.
...
SECRET_KEY = '%0s4$2r$s$tk#p2@72r_^uwov+e^+9w=%zd*61(vswtq_5w80z'
...
ROOT_URLCONF = 'misagoforumorg.urls'
...
WSGI_APPLICATION = 'misagoforumorg.wsgi.application'
